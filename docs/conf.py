# -*- coding: utf-8 -*-
#
# yamldirs documentation build configuration file, created by
...
project = u'yamldirs'
copyright = u'2016 Bjorn Pettersen'
...
latex_documents = [
  ('index', 'yamldirs.tex', u'yamldirs Documentation',
   u'', 'manual'),
]
